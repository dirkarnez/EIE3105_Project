...
%PREFIX%\winlibs-x86_64-posix-seh-gcc-11.2.0-mingw-w64-9.0.0-r1\mingw64\bin\gcc.exe -D__AVR_ATmega328P__ -I.\include -c .\src\uart.c -o %~dp0build\uartlib\uart.o &&^
...
%PREFIX%\winlibs-x86_64-posix-seh-gcc-11.2.0-mingw-w64-9.0.0-r1\mingw64\bin\ar.exe rcs %~dp0build\uartlib\uart_avr.a %~dp0build\uartlib\uart.o %~dp0build\uartlib\uart_avr.o &&^
cd %~dp0 &&^
